...
August, 2016  ~  present<br>**Major in Department of Automation, Tsinghua University, Beijing**<br>**GPA：3.44/4    Rank: 15/168   (2 years)**<br>**GPA：3.58/4	   Rank:  8/168  (first year)**
...
**Mathematics:** Calculus A(2), Introduction to Complex Analysis, Stocastic Mathematical Methods, Signals and System Analysis, Numerical Analysis and Algorithms, Principle of Automatic Control.<br>**Computer Science:** C++ Programme Design and Training, Computer Networks and Applications, Digital Image Processing.<br>**Electrical Courses：**Digital Electronics, Fundamentals of Analog Electronics, Contemporary Electronic System Design, Foundamentals of Power Electronics Technology.<br>**Others:** Computational Genome Analysis, Introduction of Terahertz Techonology, Dialogue between Neuroscience and Artificial Intelligence. 

### Minor : English

August, 2017  ~  present<br>**Minor in Department of Foreign Language and Literature, Tsinghua University, Beijing**<br>Main Course: <br>**Basic Skills:** English Reading (1)(2), English Listening (1)(2), English Writing (1), Reading & Writing for Reviews, Reading & Writing for Translation Challenges, English Interpretation.<br>**Cultural Courses:** The Foundations of Western Culture, British Society and Culture, Americian Society and Culture, From the Silver Screen: English Films Appreciation.

## Research Experience

### An Enhenced Indoor Positioning Method without Extra Deploying Devices

December, 2018 ~ present<br>**Index terms: Indoor Positioning, Inertial Navigation, Augmented Reality**
...
June, 2018  ~  present  (as team leader)<br>**Index terms: Aerial Robot Control,  Pedestrian Detection, Action Detection**
...
<div align="center"><img src="/images/fulls/drone1.png" heigh="90%" width="90%"><br><img src="/images/fulls/drone2.png" heigh="70%" width="70%"></div>



### TransGlass: Personal Assistant in Foreign Language Environment   
December, 2017  ~  May, 2018  (as team leader)<br>**Index terms: Character Translation, Augmented Reality**
...
October, 2017  ~  December, 2017 <br>**Index terms:  Inertial Navigation ,Augmented Reality, Vision Enhancement**
